...
import { Backpack, BadgeDollarSign, BookCopy, Calendar, Home, LogOut, Package2, School, Settings, Users, Vault } from 'lucide-react'
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex grow flex-col justify-center space-y-5 items-center mx-auto">
          ...
          <AdminAuthorization authorizationMode="component">
            ...
            <ToolTip content={'Schedule'} slateBlack sideOffset={8} side="right">
              <Link
                className="bg-white/5 rounded-lg p-2 hover:bg-white/10 transition-all ease-linear"
                href={`/schedule`}
              >
